...
stage('Update Kubernetes Manifests') {
    steps {
        script {
            ...
            sh """
                sed -i.bak "s|image: ${DOCKER_USER}/mon-angular-app:.*|image: ${DOCKER_USER}/mon-angular-app:${IMAGE_TAG}|" k8s/angular-app/deployment.yaml
                git add k8s/angular-app/deployment.yaml
